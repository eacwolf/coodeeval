...
export default function LoginPage({ onLoginSuccess }) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      fetch("http://localhost:5000/api/email/send-custom", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          email: email,
          subject: "New Login to Your Account - TransformNXT",
          htmlContent: `<div style="font-family: Arial, sans-serif; max-width: 600px;"><h2 style="color: #3b82f6;">New Login Detected</h2><p>You just logged into your TransformNXT account.</p><p><strong>Login Time:</strong> ${new Date().toLocaleString()}</p><p>If this wasn't you, please contact support immediately.</p></div>`
        }),
      ...
      >
        <div style={{ marginBottom: 40, textAlign: "center" }}>
          ...
          <p style={{ fontSize: 14, color: T.textSub, lineHeight: 1.6 }}>
            Sign in to CodeEval AI platform
          </p>
        </div>
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 10,
            border: "none",
            background: !email || !password || loading ? T.border : T.accent,
            color: "#fff",
            fontWeight: 600,
            fontSize: 15,
            ...
            justifyContent: "center",
            gap: 10,
            boxShadow: !email || !password || loading ? "none" : `0 8px 20px rgba(59, 130, 246, 0.3)`,
